    ...
    <section className="py-16 md:py-24">
      <div className="container">
        ...
        <div className="max-w-4xl mx-auto space-y-6 text-gray-700">
          <p>
            The information contained on the Durotech website is provided for
          ...
          <p>
            In no event will Durotech be liable for any loss or damage including
          ...
          <p>
            ...
            which are not under the control of Durotech. We have no control over
          ...
          <p>
            Any market information provided on this website is for general
            informational purposes only and should not be construed as
            investment advice or a recommendation to buy, sell, or trade any
            commodity. Market conditions can change rapidly, and past
